...
export function StripeDonationModule() {
  ...
  const oneTimeTiers: DonationTier[] = [
    {
      ...
      amount: 25,
      label: "$25",
      description: "Sustains research to audit and verify vital records replacement and fee waiver routes.",
    ...
    },
    {
      ...
      amount: 50,
      label: "$50",
      description: "Funds field investigation of emergency transit, gas voucher, and phone safety pathways.",
    ...
    },
    {
      ...
      amount: 100,
      label: "$100",
      description: "Supports ongoing research into utility deposit waivers and statutory lease-break enforcement.",
    ...
    },
    {
      ...
      amount: 250,
      label: "$250",
      description: "Sustains field research into emergency companion animal boarding and foster networks.",
  ...
  const monthlyTiers: DonationTier[] = [
    ...
    },
    {
      ...
      amount: 50,
      label: "$50 / mo",
      description: "Sustains research and development for the Central Texas pilot gap-removal framework.",
