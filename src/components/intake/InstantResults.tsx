...
export function InstantResults({
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-brand-charcoal border border-stone-700 rounded-xl p-6 shadow-xl">
        ...
        <div className="flex flex-wrap gap-2 text-xs font-mono text-stone-300">
          {matchResult.breakdown.locationCount > 0 && (
            <span className="px-2.5 py-1 bg-stone-900 border border-stone-700 rounded">
      ...
      <div className="space-y-4">
        ...
        {matchResult.matches.length > 0 ? (
          ...
          <div className="p-8 text-center bg-stone-900/60 rounded border border-stone-800 text-stone-400 text-xs">
      ...
      {matchResult.docket && (
        <div className="bg-stone-950 border border-stone-800 rounded-xl p-6 text-xs text-stone-300 space-y-4">
          <div className="flex items-center justify-between border-b border-stone-800 pb-3">
            <div className="flex items-center gap-2">
              <FileText className="w-4 h-4 text-brand-ruby" />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <h4 className="font-bold text-white uppercase text-[11px] mb-2 font-mono">
              ...
              <ul className="space-y-1.5 list-disc list-inside text-stone-400">
                {matchResult.docket.resourceLevers.map((lever, i) => (
                  <li key={i}>
                    <strong className="text-stone-200">{lever.lever}:</strong> {lever.whyItMatters}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ol className="space-y-1 text-stone-400 font-mono text-[11px]">
