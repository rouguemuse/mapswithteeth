    ...
    <section className="space-y-8 select-none font-sans">
      <div className="border-b border-[#D9D1C4] pb-5 space-y-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <span className="coord-tick">[PROTOTYPE · FIELD VALIDATION · ROADMAP]</span>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 space-y-4 shadow-2xs">
          <div className="flex items-center justify-between border-b border-[#D9D1C4] pb-3 font-mono text-[10px]">
            <span className="text-emerald-800 font-bold uppercase flex items-center gap-1.5">
        ...
        <div className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 space-y-4 shadow-2xs">
          <div className="flex items-center justify-between border-b border-[#D9D1C4] pb-3 font-mono text-[10px]">
            <span className="text-amber-800 font-bold uppercase flex items-center gap-1.5">
        ...
        <div className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 space-y-4 shadow-2xs">
          <div className="flex items-center justify-between border-b border-[#D9D1C4] pb-3 font-mono text-[10px]">
            <span className="text-[#971F26] font-bold uppercase flex items-center gap-1.5">
              <Milestone className="w-3.5 h-3.5 text-[#971F26]" />
