    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-14 select-none font-sans">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2 text-[#971F26]">
            ...
            <span className="text-xs font-mono font-bold tracking-widest uppercase">
              CONTINUITY INFRASTRUCTURE LAYER · STAGE 03 PILOT
            </span>
          </div>
          <span className="coord-tick text-stone-700">[PROTOCOL: CONTINUITY-RECEIPT-V0]</span>
        </div>
      ...
      <section className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 sm:p-8 space-y-6 shadow-sm bg-grid-diagram">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 font-mono text-xs">
          <div className="p-4 bg-[#F5F1E8] border-2 border-[#1C1D1D] rounded-lg space-y-1.5">
            <span className="text-[10px] font-bold text-[#971F26] uppercase">TOUCHPOINT 01</span>
            <h3 className="font-serif font-bold text-sm text-[#1C1D1D]">Police / Crisis Hotline</h3>
            <p className="text-[11px] font-sans text-stone-700 leading-tight">
              Incident recorded. Told it is a &ldquo;civil matter&rdquo; or out of jurisdiction. Referred to County Shelter.
            </p>
          </div>

          <div className="p-4 bg-[#F5F1E8] border-2 border-[#1C1D1D] rounded-lg space-y-1.5">
            <span className="text-[10px] font-bold text-[#971F26] uppercase">TOUCHPOINT 02</span>
            <h3 className="font-serif font-bold text-sm text-[#1C1D1D]">County Shelter</h3>
            <p className="text-[11px] font-sans text-stone-700 leading-tight">
          ...
          <div className="p-4 bg-[#F5F1E8] border-2 border-[#1C1D1D] rounded-lg space-y-1.5">
            <span className="text-[10px] font-bold text-[#971F26] uppercase">TOUCHPOINT 03</span>
            <h3 className="font-serif font-bold text-sm text-[#1C1D1D]">Legal Aid Office</h3>
            <p className="text-[11px] font-sans text-stone-700 leading-tight">
              Cannot assist without original offense report number. Told to return to Touchpoint 01.
            </p>
          </div>

          <div className="p-4 bg-[#FDF2F2] border-2 border-[#971F26] rounded-lg space-y-1.5 flex flex-col justify-between">
            <div>
              <span className="text-[10px] font-bold text-[#971F26] uppercase">THE DEAD END</span>
              <h3 className="font-serif font-bold text-sm text-[#971F26]">Context Lost</h3>
              <p className="text-[11px] font-sans text-stone-900 leading-tight">
                40+ hours spent. Documents scattered. No single decision-owner identified.
              </p>
            </div>
            <span className="text-[9px] font-mono font-bold text-[#971F26] uppercase bg-white/80 px-1.5 py-0.5 rounded border border-[#971F26]/30 self-start mt-2">
              REPEAT CYCLE
            </span>
          </div>
        </div>
      ...
      <section className="space-y-6">
        <div className="border-b border-[#D9D1C4] pb-4">
          ...
          <p className="text-sm text-stone-800 mt-1 leading-relaxed font-sans">
        ...
        <div className="bg-[#F5F1E8] border-2 border-[#1C1D1D] rounded-xl p-6 sm:p-8 space-y-6 shadow-sm font-mono relative overflow-hidden">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-dashed border-[#1C1D1D] pb-4">
            <div>
              ...
              <span className="font-bold text-sm sm:text-base text-[#1C1D1D]">
                RECEIPT ID: CR-2026-TX-08942
              </span>
            </div>
            <span className="px-2.5 py-1 bg-[#E8F3EB] border border-[#2D5A3D] text-[#2D5A3D] font-bold text-xs rounded-xs">
              ✓ CONTEXT LOCKED
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
            ...
            <div className="space-y-4">
              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">1. WHO & JURISDICTION</span>
                <p className="text-stone-900 font-semibold">Austin Police Dept · Victim Services Unit</p>
                <p className="text-stone-600 text-[11px]">Officer J. Miller · Badge #4102 · Travis County, TX</p>
              </div>

              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">2. WHEN & CONTACT METHOD</span>
                <p className="text-stone-900">August 28, 2026 · 14:15 CST · In-Person Desk Intake</p>
              </div>

              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">3. REFERENCE & IDENTIFIER</span>
                <p className="text-stone-900">Incident Report #: APD-2026-0828-441</p>
                <p className="text-stone-600 text-[11px]">Original CAD Call Log: #26-240-0891</p>
              </div>

              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">4. WHAT WAS PRESENTED</span>
                <p className="text-stone-900">• Coercive phone tracking via shared cellular plan</p>
                <p className="text-stone-900">• Threat text messages & apartment lease copy</p>
                <p className="text-stone-700 text-[11px] italic font-sans pt-1">
            ...
            <div className="space-y-4">
              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">5. WHAT HAPPENED & ACTION TAKEN</span>
                <p className="text-stone-900 font-semibold">Action Declined · Labeled &ldquo;Civil Dispute&rdquo;</p>
                <p className="text-stone-600 text-[11px]">No formal protective order application initiated.</p>
              </div>

              <div className="space-y-1 p-3 bg-[#EEE8DD] border border-[#D9D1C4] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">6. WHY (STATED REASON)</span>
                <p className="text-stone-900">Officer stated carrier account primary name is spouse.</p>
                <p className="text-[#971F26] text-[11px] font-sans font-semibold pt-1">
                  System note: Fails to recognize federal Safe Connections Act (47 U.S.C. § 345) statutory remedy.
                </p>
              </div>

              <div className="space-y-1 p-3 bg-[#FDF2F2] border border-[#971F26] rounded">
                <span className="text-[10px] uppercase font-bold text-[#971F26] block">7. WHAT HAPPENS NEXT</span>
                <p className="text-stone-900 font-bold">Referral Destination: Legal Aid of NorthWest Texas</p>
                <p className="text-stone-700 text-[11px]">Next Decision-Owner: Staff Attorney / Intake Paralegal</p>
                <p className="text-stone-700 text-[11px]">Documents Needed: Signed advocate verification letter</p>
                <p className="text-[#971F26] font-bold text-[11px] pt-1">Deadline: September 4, 2026</p>
              </div>
            </div>
          </div>

          <div className="border-t border-[#D9D1C4] pt-3 flex items-center justify-between text-[10px] text-stone-600">
      ...
      <section className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 sm:p-8 space-y-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-sans">
          <div className="p-4 bg-[#F5F1E8] border border-[#D9D1C4] rounded-lg space-y-2">
            ...
            <p className="text-stone-700 text-xs leading-snug">
          ...
          <div className="p-4 bg-[#F5F1E8] border-2 border-[#971F26] rounded-lg space-y-2">
            ...
            <div className="p-3 bg-[#FDF2F2] border border-[#971F26] text-stone-900 rounded font-mono text-[11px] space-y-1">
              ...
              <p className="text-[#971F26] font-bold uppercase">
                FLAG: NO FUNCTIONING DECISION-OWNER IDENTIFIED
              </p>
            </div>
            <p className="text-stone-800 text-xs leading-snug">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-xs">
          <div className="p-4 bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl space-y-2">
            <div className="flex items-center gap-2 text-[#971F26] font-bold">
              <FolderArchive className="w-4 h-4" />
              <span>SURVIVOR ORGANIZER</span>
            </div>
            <p className="font-sans text-xs text-stone-800 leading-snug">
              Structure incidents, dates, communications, agencies contacted, people involved, report numbers, deadlines, and outcomes into a coherent timeline.
            </p>
          </div>
      ...
      <section className="bg-[#EEE8DD] border-2 border-[#1C1D1D] rounded-xl p-6 sm:p-8 space-y-4 shadow-sm bg-grid-atlas">
        ...
        <div className="pt-2 flex flex-wrap gap-2 text-[10px] font-mono font-bold text-stone-800">
