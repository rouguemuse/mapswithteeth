...
export const OTHER_WAYS_THROUGH_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    "whatItActuallyProvides": "Direct emergency financial grants of up to $3,000 to qualifying craft artists (CURRENTLY SUSPENDED THROUGH SEPT 30, 2026).",
    "assistanceShapes": [
      "DIRECT_CASH"
    ],
    "paymentMethod": "DIRECT_TO_APPLICANT",
    "typicalAmount": "$3,000 standard emergency relief grant (CURRENTLY ON HOLD)",
    "knownFundingLimits": "Grantmaking paused July 23, 2026 through September 30, 2026",
